...
def mymain3test(adapters):
    # sortedadapters = sorted(adapters)
    # builtin = max(sortedadapters) + 3
    # sortedadapters.append(builtin)
    listofsections = [[0, 1, 2, 3, 4, 7, 8, 9, 10, 11],
[14, 15, 16, 17, 18],
[21, 22, 23, 24, 25],
[28, 29, 30, 33, 34, 35],
[38, 39, 40, 41, 42, 45],
...
[133, 134, 135, 136, 137],
[140, 141, 144, 145, 146, 147, 148, 151]]
    #print(sortedadapters)
    #print(listofsections)
    listofcounts = []
    
    for section in listofsections:
        listofcounts.append(countvalidcombos(section))
    count = 1
    for c in listofcounts:
        count = count * c
    return count


def splitlist(adapters):
    listofsections = []
    if len(adapters) <= 12:
        listofsections.append(adapters)
    else:
        for i in range(6,len(adapters)-5):
            if i > len(adapters):
                return
            print(len(adapters),i)
            if i == len(adapters)-5:
                listofsections.append(adapters[i:])
            
            elif adapters[i]-adapters[i-1] == 3:
                listofsections.append(adapters[:i])
                del adapters[:i]
                listofsections = listofsections + splitlist(adapters)
...
print('test2pt2: ',mymain3test(adapters))
...
#print('actualpt2v7: ',mymain3test(adapters))
...
# gave up pt2 v2 at 23:12


# started pt2 v3 at 22:28
# gave up pt2 v3 at 23:12

# started pt2 v4 at 22:44
# gave up pt2 v4 at 23:20

# skipped v5 implementation was too difficult

# started pt2 v6 at 23:11
# gave up pt2 v6 at 23:$6

# finished pt2 v7 at 23:45
# but cheap method of manually splitting list
# ran instantaneously though!
# should really implement method for splitting list!
